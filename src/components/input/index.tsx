...
const InputField = ({
  ...
  <div className={cx('bg-primary dark:bg-gray-800 rounded-md', className)}>
    ...
    <div className="relative flex items-center border-2 border-gray-300 dark:border-gray-900 rounded-md px-8">
      ...
      />
      {showBorderPlaceholder && <PaleBodyText className="absolute text-xs bg-primary dark:bg-gray-800 -top-8 px-4 peer-placeholder-shown:hidden">{placeholder}</PaleBodyText>}
    </div>
  </div>
);
